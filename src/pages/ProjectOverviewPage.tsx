...
const modules: { name: string; progress: number; color: string }[] = [];
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 relative z-10">
          <div className="space-y-2 min-w-0">
            ...
            <h2 className="text-[22px] font-extrabold text-white tracking-tight">产线运行状态</h2>
